    ...
    <>
      ...
      <section className="section container" aria-labelledby="about-snippet-heading">
        <div className="split about-snippet-split">
          <div>
            <h2 id="about-snippet-heading" className="section-heading">
              About us
            </h2>
            <p className="section-intro" style={{ marginBottom: "1rem" }}>
              <strong>
                Founded in 2004 with French engineering roots, KIITEC today works with partners such as FTE (Switzerland) and ADEI
                (France) while training technicians for Tanzania and the region.
              </strong>{" "}
          ...
          <div className="about-snippet-logo-wrap">
            <img
              src={logoUrl}
              alt="Don Bosco KIITEC"
              width={300}
              height={146}
              loading="lazy"
              decoding="async"
              className="about-snippet-logo"
            />
          </div>
        </div>
      </section>
      ...
      <section className="section section-alt" aria-labelledby="facilities-home-heading">
        <div className="container split">
          <div>
            <h2 id="facilities-home-heading" className="section-heading">
              Our facilities
            </h2>
            <p className="section-intro" style={{ marginBottom: "1rem" }}>
              Hostel accommodation, modern classrooms, laboratories, and workshops with up-to-date equipment support hands-on learning
              that reflects real workplaces.
            </p>
            <Link className="btn btn-primary" to="/campus">
              Campus, map &amp; photos
            </Link>
          </div>
